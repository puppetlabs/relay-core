...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *APIWorkflowRunSink) DeepCopyInto(out *APIWorkflowRunSink) {
	*out = *in
	if in.TokenFrom != nil {
		in, out := &in.TokenFrom, &out.TokenFrom
		*out = new(APITokenSource)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new APIWorkflowRunSink.
func (in *APIWorkflowRunSink) DeepCopy() *APIWorkflowRunSink {
	if in == nil {
		return nil
	}
	out := new(APIWorkflowRunSink)
	in.DeepCopyInto(out)
	return out
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *WorkflowRunSink) DeepCopyInto(out *WorkflowRunSink) {
	*out = *in
	if in.API != nil {
		in, out := &in.API, &out.API
		*out = new(APIWorkflowRunSink)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new WorkflowRunSink.
func (in *WorkflowRunSink) DeepCopy() *WorkflowRunSink {
	if in == nil {
		return nil
	}
	out := new(WorkflowRunSink)
	in.DeepCopyInto(out)
	return out
}
