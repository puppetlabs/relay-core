...
// +kubebuilder:rbac:groups=relay.sh,resources=tenants;tenants/status;webhooktriggers;webhooktriggers/status;workflows;workflows/status,verbs=get;list;watch;patch;update
