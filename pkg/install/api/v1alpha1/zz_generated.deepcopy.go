...
func (in *RelayCoreSpec) DeepCopyInto(out *RelayCoreSpec) {
	*out = *in
	...
	if in.VaultSidecar != nil {
		in, out := &in.VaultSidecar, &out.VaultSidecar
...
func (in *VaultSidecar) DeepCopyInto(out *VaultSidecar) {
	*out = *in
	...
	in.ConfigVolumeMounts.DeepCopyInto(&out.ConfigVolumeMounts)
	in.ServiceAccountVolumeMount.DeepCopyInto(&out.ServiceAccountVolumeMount)
}
